...
const Service = (props: Props) => {
    return (
        <div className="grid justify-center">
            <div className="service_1 grid grid-cols-1 sm:grid-cols-2 gap-[50px] px-[50px] py-[80px] max-[768px]:flex-col">
                ...
                <div className="content grid gap-[16px] h-fit">
                    <h3 className='text-3xl font-medium text-[#1D5936]'>About Us</h3>
            ...
            <div className="service_1 md:max-h-[800px] grid grid-cols-1 sm:grid-cols-2 items-center gap-[50px] px-[50px] py-[80px] max-[768px]:flex-col">
                ...
                <div className="content h-full grid gap-[50px]">
                    <Image src={hand_heart} width={100} height={100} className='max-h-[400px]' alt="service_imgs" />
            ...
            <div className="max-w[80%] w-full m-auto justify-items-center service_1 grid grid-cols-1 sm:grid-cols-2 items-center gap-[50px] px-[50px] py-[80px] max-[768px]:flex-col">
                <Image src={mobile_chat} alt="service_imgs" />
                <div className="content grid gap-8">
                    <h3 className='text-[#05361E] text-3xl'>Our user interface is a super friendly one!</h3>
