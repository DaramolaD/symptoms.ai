...
function Cta({ }: Props) {
    return (
        <div className="cta w-full py-[50px] md:py-[0px] flex justify-center md:block px-[20px] md:px[0px] bg-cover bg-center bg-no-repeat md:bg-[url('/male_doc.jpg')]">
            <div className="w-[450px] bg-[#05361E] md:bg-inherit rounded-[12px] md:rounded-[0px] service_1 grid grid-cols-1 items-center gap-[50px] px-[50px] py-[80px] max-[768px]:flex-col">
