...
function Hero() {
  return (
    <main className={`flex mx-auto flex-col items-start justify-center text-center px-4 pt-[50px] pl-[80px] w-[100%] h-[600px] m-0 bg-cover bg-center bg-no-repeat bg-[url('/doctor.jpg')]`}>
